...
//       // Prepare ingredients in backend-expected format
...
//       formData.append('newRecipe_title', newRecipeTitle);
//       formData.append('newIngredients', JSON.stringify(formattedIngredients));
//       formData.append('newInstructions', newInstruction);
//       formData.append('newRecipe_description', newRecipeDescription);
//       formData.append('newCookingTime', newCookingTime);
      
//       if (newRecipeImage instanceof File) {
...
//       // Normalize the response ingredients for display
//       const normalizedResponseIngredients = updatedRecipe.ingredients?.map(ing => ({
//         _id: ing._id,
//         ingredient_name: ing.ingredient_name,
//         quantity: ing.quantity,
//         description: ing.description
...
//       setRecipe({
//         ...updatedRecipe,
//         ingredients: normalizedResponseIngredients
//       });
...
//       if (!response.ok) throw new Error('Failed to fetch suggested ingredients');
//       const data = await response.json();
//       console.log('Suggested Ingredients:', data);
//       setSuggestedIngredients(data);
//     } catch (error) {
//       console.error('Error fetching suggested ingredients:', error);
//       setSuggestedIngredients([]);
...
//         {isEditing ? (
//           // Edit mode ingredients
//           <div className="space-y-3 sm:space-y-4">
//             {/* Search and suggested ingredients remain same */}
...
//                 <div className="max-h-[150px] sm:max-h-[200px] overflow-y-auto space-y-2">
//                   {newIngredients.map((ingredient, index) => (
//                     <div key={ingredient._id} className="flex items-center justify-between p-2 sm:p-3 bg-white rounded-lg shadow-sm">
//                       <div className="flex flex-col w-full">
...
//                           }}
//                           className="bg-transparent border-b border-gray-300 focus:border-purple-500 outline-none text-xs sm:text-sm mt-1"
